...
export async function importLibraryCopyFromUploadedZipFile(transferFileId: string): Promise<Task> {
    ...
    try {
        ...
        return await libraryLocalFolderService.importLibraryCopy(TEMP_EXTRACT_DIR)
    } finally {
